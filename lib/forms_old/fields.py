# Taken from Django's form module
...
class DecimalField(IntegerField):
    default_error_messages = {
        ...
        'max_digits': 'Ensure that there are no more than %(max)s digit(s) in total.',
        'max_decimal_places': 'Ensure that there are no more than %(max)s decimal place(s).',
        'max_whole_digits': 'Ensure that there are no more than %(max)s digit(s) before the decimal point.'
    }
...
class BaseTemporalField(Field):
    ...
    def to_python(self, value):
        ...
        unicode_value = str(value, strings_only=True)
...
class FileField(Field):
    ...
    default_error_messages = {
        ...
        'max_length': 'Ensure this filename has at most %(max)d character(s) (it has %(length)d).',
